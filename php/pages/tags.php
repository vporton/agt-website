...
class TagsPage extends Page {
  public function getMain() {
    ...
    $value .= "<h2>WARNING</h2>";
    $value .= "<p>The tag system for this book is not yet ripe. It is unclear whether tags should be applied to the current or to the most general (maybe yet undiscovered) version of a result or definition. So tags are not yet fixed.</p>";
    ...
    $value .= "<pre><code>@misc{agt,\n";
    $value .= "  shorthand    = {AGT},\n";
    $value .= "  author       = {The {AGT Project Authors}},\n";
    $value .= "  title        = {\itshape Algebraic General Topology},\n";
    $value .= "  howpublished = {\url{http://agt.portonvictor.org}},\n";
    $value .= "  year         = {" . date('Y'). "},\n";
    $value .= "}</code></pre>";
    ...
    $value .= "<pre><code>\cite[\href{http://agt.portonvictor.org/tag/0123}{Tag 0123}]{agt}</code></pre>";
    ...
    $value .= "<p>There is a file called <a href='https://github.com/vporton/agt-book/blob/master/tags/tags'><var>tags</var></a> (in the <a href='https://github.com/vporton/agt-book/tree/master/tags'>tags subdirectory</a> of the AGT project) which has on each line the tag followed by an identifier. Example:";
